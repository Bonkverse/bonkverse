...
#     """Fire-and-forget background sync; never raise into request thread."""
#     t0 = time.monotonic()
#     try:
...
#         )
#         logger.info("friends synced for %s: %s (%.2fs)",
...
#                         daemon=True,
#                     ).start()
#                     messages.info(request, "Syncing your friends in the background…")
